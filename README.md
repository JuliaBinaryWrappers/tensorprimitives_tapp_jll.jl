# `tensorprimitives_tapp_jll.jl` (v0.1.0+0)

[![deps](https://juliahub.com/docs/tensorprimitives_tapp_jll/deps.svg)](https://juliahub.com/ui/Packages/General/tensorprimitives_tapp_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/93d4bd7c1c893ce5409577b0ccc61988a0848e25/T/tensorprimitives_tapp/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `tensorprimitives_tapp_jll.jl` have been built from these sources:

* git repository: https://github.com/lkdvos/tensorprimitives-rs.git (revision: `ca916fae1947efa526cf7177bf06018c042fd8a6`)

## Platforms

`tensorprimitives_tapp_jll.jl` is available for the following platforms:
...
* `LibraryProduct`: `libtensorprimitives_tapp`
* `FileProduct`: `tapp_h`
